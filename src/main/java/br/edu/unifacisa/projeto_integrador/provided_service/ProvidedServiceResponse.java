...
public record ProvidedServiceResponse(
    ...
    public ProvidedServiceResponse(ProvidedService service) {
        this(service.getId(), service.getService().getName(), service.getCustomer().getFirstName(), service.getStartDate(), service.getEndDate(), service.getStatus(), service.getPaid());
    }
}